        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
                        ...
                        <div class="profile"><img src="<?php echo e(asset('admincss/img/avatar-3.jpg')); ?>" alt="..."
                                class="img-fluid">
                        ...
                        <div class="profile"><img src="<?php echo e(asset('admincss/img/avatar-2.jpg')); ?>" alt="..."
                                class="img-fluid">
                        ...
                        <div class="profile"><img src="<?php echo e(asset('admincss/img/avatar-1.jpg')); ?>" alt="..."
                                class="img-fluid">
...
<?php /**PATH D:\xampp\htdocs\ecommerce_project\resources\views/admin/header.blade.php ENDPATH**/ ?>